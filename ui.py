...
class DesktopPetUI:
    ...
    def _build_layout(self) -> None:
        self.container = tk.Frame(self.root, bg=self.TRANSPARENT_COLOR)
        ...
        self.bubble_frame.pack(side="top", pady=(8, 0))
        ...
        self.image_label.pack(side="bottom", pady=(0, 8))
    ...
    def show_question(self) -> None:
        self.set_message("💧 Hey Vijay! Did you drink water?")
        self.show_buttons()
        self.show_bubble()
